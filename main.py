...
def main():
    ...
    if args.mode == 'generate':
        ...
        dataset = gen.load_dataset_with_labels(args.dataset_dir)
        gen.generate_data(vae,dataset,args.dataset_dir,N_per_type=args.N_per_type,var_scale=args.var_scale,latent_dim=latent_dim)
